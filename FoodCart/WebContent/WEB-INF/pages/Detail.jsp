...
<div class="content-container">
	<div class="container demo-1">
		...
		<div id="slider" class="sl-slider-wrapper">
			...
			<div class="sl-slider">
				<c:forEach items="${derasarImages}" var="derasarImage" varStatus="counter">
					<div class="sl-slide bg-${counter.index}" data-orientation="horizontal"
					data-slice1-rotation="-25" data-slice2-rotation="-25"
					data-slice1-scale="2" data-slice2-scale="2">
						<div class="sl-slide-inner">
							<div><img alt="Test" src="images/${derasarImage.imagePath}" width="100%"></div>
				...
				<%-- <div class="sl-slide bg-1" data-orientation="horizontal"
					...
					data-slice1-scale="2" data-slice2-scale="2">
					<div class="sl-slide-inner">
						<div><img alt="Test" src="images/1-large.jpg" width="100%"></div>
						<h2>A bene placito</h2>
						<blockquote>
							<p>You have just dined, and however scrupulously the
								slaughterhouse is concealed in the graceful distance of miles,
				...
				<div class="sl-slide bg-2" data-orientation="vertical"
					...
					<div class="sl-slide-inner">
						...
						<h2>Regula aurea</h2>
						<blockquote>
							<p>Until he extends the circle of his compassion to all
								living things, man will not himself find peace.</p>
				...
				<div class="sl-slide bg-3" data-orientation="horizontal"
					...
					<div class="sl-slide-inner">
						...
						<blockquote>
							<p>Thousands of people who say they 'love' animals sit down
								once or twice a day to enjoy the flesh of creatures who have
								been utterly deprived of everything that could make their lives
								worth living and who endured the awful suffering and the terror
								of the abattoirs.</p>
				...
				<div class="sl-slide bg-4" data-orientation="vertical"
					...
					<div class="sl-slide-inner">
						...
						<blockquote>
							<p>The human body has no more need for cows' milk than it
								does for dogs' milk, horses' milk, or giraffes' milk.</p>
