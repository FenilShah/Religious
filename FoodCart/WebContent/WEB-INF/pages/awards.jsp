...
<div class="content-container">
	<header id="awards">
		<h1 class="center-text">Our Awards</h1>
		<h2 class="center-text">Proin vel tincidunt elit. In quis
			tincidunt dolor. In lorem mi, egestas posuere augue tristique, mattis
			semper est. Fusce feugiat dignissim orci, et pharetra felis
			ullamcorper sed.</h2>
	</header>
		...
		<div class="container-fluid">
			<div class="time_line_wap left_timeline">
				<div class="time_line_paragraph">
					...
					<p>
						You can easily change icons by <a rel="nofollow"
							href="http://fontawesome.info/font-awesome-icon-world-map/">Font
							Awesome</a>. Example: <strong>&lt;i class=&quot;fa
							fa-gift&quot;&gt;&lt;/i&gt;</strong> Nulla nec fermentum libero. Duis quis
						fermentum libero. Nunc facilisis ultrices fringilla. Nullam sed
						ligula ac libero venenatis pellentesque vitae nec mauris.
					</p>
				</div>
			</div>
			<div class="time_line_wap left_timeline">
			...
			<div class="time_line_wap left_timeline">
				<div class="time_line_paragraph">
					...
					<p>
						Cras dignissim dui laoreet tellus mattis posuere. Aenean varius
						ligula sed nisi consectetur, non faucibus sem consequat. Phasellus
						dignissim venenatis dolor, sit amet molestie nisl tempor vel.
						Proin blandit, nisi sit amet pretium adipiscing, nisi lorem
						rhoncus est, in laoreet augue justo vitae nulla. <br>
